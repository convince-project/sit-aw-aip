...
And the way to communicate with on the two model choices [here](#inference-with-vlm), given [CONVINCE](https://convince-project.eu/) use cases. For now only UC1, vacuum cleaner, and UC2, assembly robot.
